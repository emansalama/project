...
$sql = 'select coursedetails.*,courses.* , user.name as catTitle , user.image as userImage  from  coursedetails inner join courses  on coursedetails.cour_id = courses.id  inner join user on user.id = coursedetails.teachby';
...
<!--== fontawesome -->
<link href="./includes/css/fontawesome-all.css" rel="stylesheet" type="text/css" />

<!--== themify -->
<link href="./includes/css/themify-icons.css" rel="stylesheet" type="text/css" />

<!--== audioplayer -->
<link href="./includes/css/audioplayer/plyr.css" rel="stylesheet" type="text/css" />

<!--== magnific-popup -->
<link href="./includes/css/magnific-popup/magnific-popup.css" rel="stylesheet" type="text/css" />

<!--== owl-carousel -->
<link href="./includes/css/owl-carousel/owl.carousel.css" rel="stylesheet" type="text/css" />

<!--== base -->
<link href="./includes/css/base.css" rel="stylesheet" type="text/css" />

<!--== shortcodes -->
<link href="./includes/css/shortcodes.css" rel="stylesheet" type="text/css" />
        ...
        <div class="col-lg-12">
          ...
          <nav class="navbar navbar-expand-lg">
            <a class="navbar-brand logo" href="index-2.html">
              <img id="logo-img" class="img-center" src="./images/1.png" width="100px" height="50px" alt="">
            </a>
     ...
     <?php 
        ...
        <div class="post">
          <div class="post-image">
            <img class="img-fluid h-100 w-100" src="./Admin/Detailscourses/uploads/<?php echo $data['image'];?>" alt="">
          </div>
          <div class="post-desc">
            <div class="post-date"><?php echo date('d',$data['appoinment'])?> <span><?php echo date('F Y',$data['appoinment'])?></span>
            </div>
            <div class="post-title">
              <h5><a href="blog-details.html"><?php echo $data['title'].' ( '.$data['catTitle'].')';?></a></h5>
            </div>
            ...
            <div class="post-author">
             ...
             $sql="select status,cour_id from orders where email='$email' ";
             ...
             $op2 = mysqli_query($con,$sql);
              ...
              ?>
              <?php if($data2['status'] == 1 && $data['id']==$data2['cour_id']): ?>
                <a href="http://localhost/week3/book.php?id=<?php echo $data['id']; ?>" class='btn btn-primary m-r-1em'>Booking</a>
                    <?php else: ?>
                      <a href="http://localhost/week3/booking.php?id=<?php echo $data['id']; ?>" class='btn btn-primary m-r-1em'>Booking</a>
...
<!--== audioplayer -->
<script src="./includes/js/audioplayer/plyr.min.js"></script>

<!--== magnific-popup -->
<script src="./includes/js/magnific-popup/jquery.magnific-popup.min.js"></script> 

<!--== owl-carousel -->
<script src="./includes/js/owl-carousel/owl.carousel.min.js"></script> 

<!--== counter -->
<script src="./includes/js/counter/counter.js"></script> 

<!--== countdown -->
<script src="./includes/js/countdown/jquery.countdown.min.js"></script> 

<!--== isotope -->
<script src="./includes/js/isotope/isotope.pkgd.min.js"></script> 

<!--== mouse-parallax -->
<script src="./includes/js/mouse-parallax/tweenmax.min.js"></script>
<script src="./includes/js/mouse-parallax/jquery-parallax.js"></script> 

<!--== contact-form -->
<script src="./includes/js/contact-form/contact-form.js"></script>
